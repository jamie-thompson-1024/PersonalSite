        ...
        <main className="AboutMe PageCommon">
            <div className="AboutMe-Head">
                <div>
                    ...
                    <p>
                        I am a mostly self-taught software developer based outside of Christchurch, NZ. Who is interested in 
            ...
            <div className="AboutMe-Body">
                <p>
                    ...
                    But am fully willing to learn new frameworks and languages to further my knowledge and experience.
                    ...
                    <br />< br />
                    Through tertiary education I have also developed some skills in C# and Java. Although not used 
